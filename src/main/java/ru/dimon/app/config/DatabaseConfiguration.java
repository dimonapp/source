...
@Configuration
@EnableJpaRepositories("ru.dimon.app.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("ru.dimon.app.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "ru.dimon.app.config.HerokuDatabaseConfiguration")
